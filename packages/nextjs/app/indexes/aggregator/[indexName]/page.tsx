...
import { Account, useBalance } from "@nice-xrpl/react-xrpl";
...
import { Client, Wallet, generateFaucetWallet } from "xrpl";
...
async function createAddress() {
  ...
  console.log("New Address:", wallet.classicAddress);
  console.log("Secret:", wallet.seed);

  // Optionally, fund the address with testnet XRP using the faucet
  const test_wallet = await generateFaucetWallet(client, { wallet });
  console.log("Funded Address:", test_wallet.wallet.classicAddress);
  console.log("Balance:", test_wallet.balance);
